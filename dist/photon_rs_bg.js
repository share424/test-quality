...
* @returns {PhotonImage}
*/
export function grayscale_human_corrected_1channel(img) {
    _assertClass(img, PhotonImage);
    var ptr0 = img.__destroy_into_raw();
    const ret = wasm.grayscale_human_corrected_1channel(ptr0);
    return PhotonImage.__wrap(ret);
}
...
* @returns {PhotonImage}
*/
export function open_from_image_data(imgdata, width, height) {
    const ret = wasm.open_from_image_data(addHeapObject(imgdata), width, height);
    return PhotonImage.__wrap(ret);
}
...
* @param {PhotonImage} photon_image
*/
export function laplace_1channel(photon_image) {
    _assertClass(photon_image, PhotonImage);
    wasm.laplace_1channel(photon_image.__wbg_ptr);
}
...
/**
* @param {PhotonImage} photon_image
* @param {number} det_shape
* @returns {PreprocessedImage}
*/
export function preprocess_detector(photon_image, det_shape) {
    _assertClass(photon_image, PhotonImage);
    var ptr0 = photon_image.__destroy_into_raw();
    const ret = wasm.preprocess_detector(ptr0, det_shape);
    return PreprocessedImage.__wrap(ret);
}
...
* @param {number} _thresh
* @param {number} score_threshold
* @param {number} max_candidates
* @param {number} height_threshold
* @param {number} width_threshold
* @param {number} num_threshold
* @returns {boolean}
*/
export function postprocess_detector(data, height, width, original_height, original_width, _thresh, score_threshold, max_candidates, height_threshold, width_threshold, num_threshold) {
    const ptr0 = passArrayF32ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.postprocess_detector(ptr0, len0, height, width, original_height, original_width, _thresh, score_threshold, max_candidates, height_threshold, width_threshold, num_threshold);
    return ret !== 0;
}
...
export class PreprocessedImage {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(PreprocessedImage.prototype);
        obj.__wbg_ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_preprocessedimage_free(ptr);
    }
    /**
    ...
    */
    get_data() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.preprocessedimage_get_data(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    get_width() {
        const ret = wasm.preprocessedimage_get_width(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    * @returns {number}
    */
    get_height() {
        const ret = wasm.preprocessedimage_get_height(this.__wbg_ptr);
        return ret >>> 0;
    }
}
/**
...
export function __wbg_width_020d7bde350571e9(arg0) {
    const ret = getObject(arg0).width;
    return ret;
};

export function __wbg_height_d65d28af1b6f26d3(arg0) {
...
export function __wbg_drawImage_fa7fd856fb164132() { return handleError(function (arg0, arg1, arg2, arg3) {
...
export function __wbg_width_250e8da00ab1c884(arg0) {
    const ret = getObject(arg0).width;
    return ret;
};

export function __wbg_height_e41b71b2f3141e8e(arg0) {
    const ret = getObject(arg0).height;
    return ret;
};
